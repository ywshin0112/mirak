			...
			<div class="row justify-content-center">
				<div class="col-xl-7 ftco-animate">
					<form action="/join" method="post" onsubmit="return Duplicate();" class="billing-form">
						...
						<div class="row mb-5">
							<div class="col-md-6">
								<input type="submit" tabIndex="14" value="회원가입" id="joinSubmit" class="btn btn-primary py-3 px-5 w-100" onclick="return injungkeyForm() && checkAgeInput() && checkAddressInput();">
							</div>
							<div class="col-md-6">
