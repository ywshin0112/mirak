		...
		<div class="row justify-content-center">
			<div class="col-xl-7">
				<div class="row">
					...
					<div class="col-md-4">
						<a href="/admin/memberUpdate/${curPage}/${member.mem_code}" class="btn btn-primary py-3 px-5 w-100">수정</a>
					</div>
					<div class="col-md-4">
						<a href="/admin/memberDel/${curPage}/${member.mem_code}" class="btn btn-danger py-3 px-5 w-100" onclick="return confirmDelMember()">삭제</a>
					</div>
				</div>
			</div>
		</div>
