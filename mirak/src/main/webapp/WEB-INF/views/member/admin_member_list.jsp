								...
								<c:if test="${pageMaker.prev}">
									<ul>
										<li class="pageInfo_btn previous"><a
											href="javascript:acyncMovePage('/admin/members?pageNum= ${pageMaker.startPage-1}');">&lt;</a></li>
									</ul>
								</c:if>
								...
								<c:if test="${pageMaker.next}">
									<ul>
										<li class="pageInfo_btn next"><a
											href="javascript:acyncMovePage('/admin/members?pageNum=${pageMaker.endPage + 1 }');">&gt;</a></li>
									</ul>
								</c:if>
							</tr>
						</table>
