            ...
            <div class="row mt-5 pt-3">
               ...
               <div class="col-md-12">
                  <div class="cart-detail p-3 p-md-4">
                     ...
                     <a href="/payInfo" class="btn btn-primary py-3 px-5 l-100 mb-2">결제내역 보기</a><br>
                        
                     <c:if test="${payVOList[0].status eq '결제 완료'}">                        
                        <button id="payCancel" class="btn btn-black py-3 px-5 l-100 d-block" data-group_id="${payVOList[0].group_id }">결제 취소</button><br>
                     </c:if>
                     <c:if test="${payVOList[0].status eq '배송중'}">   
                        <button id="payConfirm" class="btn btn-black py-3 px-5 l-100 d-block">구매확정</button><br>
                     </c:if>
