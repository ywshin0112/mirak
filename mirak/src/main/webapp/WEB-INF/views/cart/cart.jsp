...
%>
   ...
   <section class="ftco-section ftco-cart">
      ...
      <!-- Modal -->
<form method="post" action="/cartUpdate/pro_code=${pro_code}">
<c:forEach var="c" items="${cartList }">
         ...
         <div class="modal-dialog modal-lg">
            <div class="modal-content">
               ...
               &nbsp;&nbsp;&nbsp; ${c.pro_name }  &nbsp;&nbsp;&nbsp; ${c.pro_price }원<br>
                     <br>배송 시작일 선택<br>
                     <input type="date" id="start" name="cart_start" class="form-control input-number" style="width: 240px;" value="${c.cart_start }">
                     <br>배송 요일 선택 <br>
                     <label for="mon"><input type="checkbox" name="cart_day" id="mon" style="transform: scale(2);" value="${c.cart_day }">&nbsp;&nbsp;월</label> &nbsp;&nbsp;
               <label for="tue"><input type="checkbox" name="cart_day" id="tue" style="transform: scale(2);" value="${c.cart_day }">&nbsp;&nbsp;화</label> &nbsp;&nbsp;
               <label for="wed"><input type="checkbox" name="cart_day" id="wed" style="transform: scale(2);" value="${c.cart_day }">&nbsp;&nbsp;수</label> &nbsp;&nbsp;
               <label for="thu"><input type="checkbox" name="cart_day" id="thu" style="transform: scale(2);" value="${c.cart_day }">&nbsp;&nbsp;목</label> &nbsp;&nbsp;
               <label for="fri"><input type="checkbox" name="cart_day" id="fri" style="transform: scale(2);" value="${c.cart_day }">&nbsp;&nbsp;금</label> &nbsp;&nbsp;
               <label for="sat"><input type="checkbox" name="cart_day" id="sat" style="transform: scale(2);" value="${c.cart_day }">&nbsp;&nbsp;토</label> &nbsp;&nbsp;
               <label for="sun"><input type="checkbox" name="cart_day" id="sun" style="transform: scale(2);" value="${c.cart_day }">&nbsp;&nbsp;일</label>
                     <br>
                     <br>
                  배송 횟수 선택 <br>
...
<%--                <a href="/cart/cartUpdate/${c.cart_code}" class="btn btn-primary py-3 px-5">변경</a> --%>
               <input type="submit" value="변경" class="btn btn-primary py-3 px-5" style="width:130px;" id="up">
