...
public class Interceptor extends HandlerInterceptorAdapter{
   ...
   static final String[] EXCLUDE_URL_LIST = {"/admin", "/join", "/idCheck", "/login", "/ProductClientList", "/ProductClientListP", "/ProductClientListT", "/ProductClientListQ", "/ProductClientDetail" , "/naverSave","/apiJoin", "/mailCheck", "/memupdate","/idfind","/pwreset"};
